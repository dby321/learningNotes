...
| `com.fasterxml.jackson.jr`                      | `jackson-jr-stree`                                  | `2.15.2`               |
...
| `io.dropwizard.metrics`                         | `metrics-caffeine`                                  | `4.2.19`               |
...
| `io.micrometer`                                 | `micrometer-registry-appoptics`                     | `1.11.1`               |
...
| `org.apache.groovy`                             | `groovy-jmx`                                        | `4.0.12`               |
...
| `org.glassfish.jersey.connectors`               | `jersey-apache5-connector`                          | `3.1.2`                |
...
| `org.glassfish.jersey.ext.cdi`                  | `jersey-cdi1x-validation`                           | `3.1.2`                |
...
| `org.hibernate.orm`                             | `hibernate-ant`                                     | `6.2.5.Final`          |
...
| `org.infinispan`                                | `infinispan-client-rest`                            | `14.0.11.Final`        |
...
| `org.infinispan`                                | `infinispan-scripting`                              | `14.0.11.Final`        |
...
| `org.jetbrains.kotlin`                          | `kotlin-osgi-bundle`                                | `1.8.22`               |
...
| `org.jetbrains.kotlinx`                         | `kotlinx-coroutines-jdk9`                           | `1.7.1`                |
...
| `org.jetbrains.kotlinx`                         | `kotlinx-coroutines-rx3`                            | `1.7.1`                |
| `org.jetbrains.kotlinx`                         | `kotlinx-coroutines-slf4j`                          | `1.7.1`                |
| `org.jetbrains.kotlinx`                         | `kotlinx-coroutines-swing`                          | `1.7.1`                |
| `org.jetbrains.kotlinx`                         | `kotlinx-coroutines-test`                           | `1.7.1`                |
| `org.jetbrains.kotlinx`                         | `kotlinx-coroutines-test-jvm`                       | `1.7.1`                |
| `org.jooq`                                      | `jooq`                                              | `3.18.4`               |
| `org.jooq`                                      | `jooq-codegen`                                      | `3.18.4`               |
| `org.jooq`                                      | `jooq-kotlin`                                       | `3.18.4`               |
...
| `org.mockito`                                   | `mockito-android`                                   | `5.4.0`                |
| `org.mockito`                                   | `mockito-core`                                      | `5.4.0`                |
| `org.mockito`                                   | `mockito-errorprone`                                | `5.4.0`                |
| `org.mockito`                                   | `mockito-junit-jupiter`                             | `5.4.0`                |
| `org.mockito`                                   | `mockito-proxy`                                     | `5.4.0`                |
| `org.mockito`                                   | `mockito-subclass`                                  | `5.4.0`                |
...
| `org.seleniumhq.selenium`                       | `htmlunit-driver`                                   | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `lift`                                              | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-api`                                      | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-chrome-driver`                            | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-chromium-driver`                          | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-devtools-v108`                            | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-devtools-v109`                            | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-devtools-v110`                            | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-devtools-v85`                             | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-edge-driver`                              | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-firefox-driver`                           | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-grid`                                     | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-http`                                     | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-http-jdk-client`                          | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-ie-driver`                                | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-java`                                     | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-json`                                     | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-manager`                                  | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-remote-driver`                            | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-safari-driver`                            | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-session-map-jdbc`                         | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-session-map-redis`                        | `4.10.0`               |
| `org.seleniumhq.selenium`                       | `selenium-support`                                  | `4.10.0`               |
...
| `org.springframework`                           | `spring-aop`                                        | `6.1.0-M1`             |
| `org.springframework`                           | `spring-aspects`                                    | `6.1.0-M1`             |
| `org.springframework`                           | `spring-beans`                                      | `6.1.0-M1`             |
| `org.springframework`                           | `spring-context`                                    | `6.1.0-M1`             |
| `org.springframework`                           | `spring-context-indexer`                            | `6.1.0-M1`             |
| `org.springframework`                           | `spring-context-support`                            | `6.1.0-M1`             |
| `org.springframework`                           | `spring-core`                                       | `6.1.0-M1`             |
| `org.springframework`                           | `spring-core-test`                                  | `6.1.0-M1`             |
| `org.springframework`                           | `spring-expression`                                 | `6.1.0-M1`             |
| `org.springframework`                           | `spring-instrument`                                 | `6.1.0-M1`             |
| `org.springframework`                           | `spring-jcl`                                        | `6.1.0-M1`             |
| `org.springframework`                           | `spring-jdbc`                                       | `6.1.0-M1`             |
| `org.springframework`                           | `spring-jms`                                        | `6.1.0-M1`             |
| `org.springframework`                           | `spring-messaging`                                  | `6.1.0-M1`             |
| `org.springframework`                           | `spring-orm`                                        | `6.1.0-M1`             |
| `org.springframework`                           | `spring-oxm`                                        | `6.1.0-M1`             |
| `org.springframework`                           | `spring-r2dbc`                                      | `6.1.0-M1`             |
| `org.springframework`                           | `spring-test`                                       | `6.1.0-M1`             |
| `org.springframework`                           | `spring-tx`                                         | `6.1.0-M1`             |
| `org.springframework`                           | `spring-web`                                        | `6.1.0-M1`             |
| `org.springframework`                           | `spring-webflux`                                    | `6.1.0-M1`             |
| `org.springframework`                           | `spring-webmvc`                                     | `6.1.0-M1`             |
| `org.springframework`                           | `spring-websocket`                                  | `6.1.0-M1`             |
| `org.springframework.amqp`                      | `spring-amqp`                                       | `3.0.5`                |
| `org.springframework.amqp`                      | `spring-rabbit`                                     | `3.0.5`                |
| `org.springframework.amqp`                      | `spring-rabbit-junit`                               | `3.0.5`                |
| `org.springframework.amqp`                      | `spring-rabbit-stream`                              | `3.0.5`                |
| `org.springframework.amqp`                      | `spring-rabbit-test`                                | `3.0.5`                |
| `org.springframework.batch`                     | `spring-batch-core`                                 | `5.0.2`                |
| `org.springframework.batch`                     | `spring-batch-infrastructure`                       | `5.0.2`                |
| `org.springframework.batch`                     | `spring-batch-integration`                          | `5.0.2`                |
| `org.springframework.batch`                     | `spring-batch-test`                                 | `5.0.2`                |
| `org.springframework.boot`                      | `spring-boot`                                       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-actuator`                              | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-actuator-autoconfigure`                | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-autoconfigure`                         | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-autoconfigure-processor`               | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-buildpack-platform`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-configuration-metadata`                | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-configuration-processor`               | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-devtools`                              | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-docker-compose`                        | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-jarmode-layertools`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-loader`                                | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-loader-tools`                          | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-properties-migrator`                   | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter`                               | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-activemq`                      | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-actuator`                      | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-amqp`                          | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-aop`                           | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-artemis`                       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-batch`                         | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-cache`                         | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-cassandra`                | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-cassandra-reactive`       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-couchbase`                | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-couchbase-reactive`       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-elasticsearch`            | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-jdbc`                     | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-jpa`                      | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-ldap`                     | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-mongodb`                  | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-mongodb-reactive`         | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-neo4j`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-r2dbc`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-redis`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-redis-reactive`           | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-data-rest`                     | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-freemarker`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-graphql`                       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-groovy-templates`              | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-hateoas`                       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-integration`                   | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-jdbc`                          | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-jersey`                        | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-jetty`                         | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-jooq`                          | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-json`                          | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-log4j2`                        | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-logging`                       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-mail`                          | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-mustache`                      | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-oauth2-authorization-server`   | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-oauth2-client`                 | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-oauth2-resource-server`        | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-quartz`                        | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-reactor-netty`                 | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-rsocket`                       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-security`                      | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-test`                          | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-thymeleaf`                     | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-tomcat`                        | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-undertow`                      | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-validation`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-web`                           | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-web-services`                  | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-webflux`                       | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-starter-websocket`                     | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-test`                                  | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-test-autoconfigure`                    | `3.2.0-SNAPSHOT`       |
| `org.springframework.boot`                      | `spring-boot-testcontainers`                        | `3.2.0-SNAPSHOT`       |
| `org.springframework.data`                      | `spring-data-cassandra`                             | `4.1.1`                |
| `org.springframework.data`                      | `spring-data-commons`                               | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-couchbase`                             | `5.1.1`                |
| `org.springframework.data`                      | `spring-data-elasticsearch`                         | `5.1.1`                |
| `org.springframework.data`                      | `spring-data-envers`                                | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-jdbc`                                  | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-jpa`                                   | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-keyvalue`                              | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-ldap`                                  | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-mongodb`                               | `4.1.1`                |
| `org.springframework.data`                      | `spring-data-neo4j`                                 | `7.1.1`                |
| `org.springframework.data`                      | `spring-data-r2dbc`                                 | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-redis`                                 | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-relational`                            | `3.1.1`                |
| `org.springframework.data`                      | `spring-data-rest-core`                             | `4.1.1`                |
| `org.springframework.data`                      | `spring-data-rest-hal-explorer`                     | `4.1.1`                |
| `org.springframework.data`                      | `spring-data-rest-webmvc`                           | `4.1.1`                |
| `org.springframework.graphql`                   | `spring-graphql`                                    | `1.2.1`                |
| `org.springframework.graphql`                   | `spring-graphql-test`                               | `1.2.1`                |
| `org.springframework.hateoas`                   | `spring-hateoas`                                    | `2.1.0`                |
| `org.springframework.integration`               | `spring-integration-amqp`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-camel`                          | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-cassandra`                      | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-core`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-event`                          | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-feed`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-file`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-ftp`                            | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-graphql`                        | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-groovy`                         | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-hazelcast`                      | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-http`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-ip`                             | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-jdbc`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-jms`                            | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-jmx`                            | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-jpa`                            | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-kafka`                          | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-mail`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-mongodb`                        | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-mqtt`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-r2dbc`                          | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-redis`                          | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-rsocket`                        | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-scripting`                      | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-security`                       | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-sftp`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-smb`                            | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-stomp`                          | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-stream`                         | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-syslog`                         | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-test`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-test-support`                   | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-webflux`                        | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-websocket`                      | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-ws`                             | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-xml`                            | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-xmpp`                           | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-zeromq`                         | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-zip`                            | `6.1.1`                |
| `org.springframework.integration`               | `spring-integration-zookeeper`                      | `6.1.1`                |
| `org.springframework.kafka`                     | `spring-kafka`                                      | `3.0.8`                |
| `org.springframework.kafka`                     | `spring-kafka-test`                                 | `3.0.8`                |
| `org.springframework.ldap`                      | `spring-ldap-core`                                  | `3.1.0`                |
| `org.springframework.ldap`                      | `spring-ldap-ldif-core`                             | `3.1.0`                |
| `org.springframework.ldap`                      | `spring-ldap-odm`                                   | `3.1.0`                |
| `org.springframework.ldap`                      | `spring-ldap-test`                                  | `3.1.0`                |
...
| `org.springframework.security`                  | `spring-security-acl`                               | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-aspects`                           | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-cas`                               | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-config`                            | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-core`                              | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-crypto`                            | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-data`                              | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-ldap`                              | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-messaging`                         | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-oauth2-authorization-server`       | `1.1.1`                |
| `org.springframework.security`                  | `spring-security-oauth2-client`                     | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-oauth2-core`                       | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-oauth2-jose`                       | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-oauth2-resource-server`            | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-rsocket`                           | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-saml2-service-provider`            | `6.1.1`                |
| `org.springframework.security`                  | `spring-security-taglibs`                           | `6.1.1`                |
...
| `org.springframework.session`                   | `spring-session-data-mongodb`                       | `3.1.1`                |
| `org.springframework.session`                   | `spring-session-data-redis`                         | `3.1.1`                |
| `org.springframework.session`                   | `spring-session-hazelcast`                          | `3.1.1`                |
| `org.springframework.session`                   | `spring-session-jdbc`                               | `3.1.1`                |
| `org.springframework.ws`                        | `spring-ws-core`                                    | `4.0.5`                |
| `org.springframework.ws`                        | `spring-ws-security`                                | `4.0.5`                |
| `org.springframework.ws`                        | `spring-ws-support`                                 | `4.0.5`                |
| `org.springframework.ws`                        | `spring-ws-test`                                    | `4.0.5`                |
| `org.springframework.ws`                        | `spring-xml`                                        | `4.0.5`                |
| `org.testcontainers`                            | `azure`                                             | `1.18.3`               |
| `org.testcontainers`                            | `cassandra`                                         | `1.18.3`               |
| `org.testcontainers`                            | `clickhouse`                                        | `1.18.3`               |
| `org.testcontainers`                            | `cockroachdb`                                       | `1.18.3`               |
| `org.testcontainers`                            | `consul`                                            | `1.18.3`               |
| `org.testcontainers`                            | `couchbase`                                         | `1.18.3`               |
| `org.testcontainers`                            | `cratedb`                                           | `1.18.3`               |
| `org.testcontainers`                            | `database-commons`                                  | `1.18.3`               |
| `org.testcontainers`                            | `db2`                                               | `1.18.3`               |
| `org.testcontainers`                            | `dynalite`                                          | `1.18.3`               |
| `org.testcontainers`                            | `elasticsearch`                                     | `1.18.3`               |
| `org.testcontainers`                            | `gcloud`                                            | `1.18.3`               |
| `org.testcontainers`                            | `hivemq`                                            | `1.18.3`               |
| `org.testcontainers`                            | `influxdb`                                          | `1.18.3`               |
| `org.testcontainers`                            | `jdbc`                                              | `1.18.3`               |
| `org.testcontainers`                            | `junit-jupiter`                                     | `1.18.3`               |
| `org.testcontainers`                            | `k3s`                                               | `1.18.3`               |
| `org.testcontainers`                            | `kafka`                                             | `1.18.3`               |
| `org.testcontainers`                            | `localstack`                                        | `1.18.3`               |
| `org.testcontainers`                            | `mariadb`                                           | `1.18.3`               |
| `org.testcontainers`                            | `mockserver`                                        | `1.18.3`               |
| `org.testcontainers`                            | `mongodb`                                           | `1.18.3`               |
| `org.testcontainers`                            | `mssqlserver`                                       | `1.18.3`               |
| `org.testcontainers`                            | `mysql`                                             | `1.18.3`               |
| `org.testcontainers`                            | `neo4j`                                             | `1.18.3`               |
| `org.testcontainers`                            | `nginx`                                             | `1.18.3`               |
| `org.testcontainers`                            | `oracle-xe`                                         | `1.18.3`               |
| `org.testcontainers`                            | `orientdb`                                          | `1.18.3`               |
| `org.testcontainers`                            | `postgresql`                                        | `1.18.3`               |
| `org.testcontainers`                            | `presto`                                            | `1.18.3`               |
| `org.testcontainers`                            | `pulsar`                                            | `1.18.3`               |
| `org.testcontainers`                            | `questdb`                                           | `1.18.3`               |
| `org.testcontainers`                            | `r2dbc`                                             | `1.18.3`               |
| `org.testcontainers`                            | `rabbitmq`                                          | `1.18.3`               |
| `org.testcontainers`                            | `redpanda`                                          | `1.18.3`               |
| `org.testcontainers`                            | `selenium`                                          | `1.18.3`               |
| `org.testcontainers`                            | `solace`                                            | `1.18.3`               |
| `org.testcontainers`                            | `solr`                                              | `1.18.3`               |
| `org.testcontainers`                            | `spock`                                             | `1.18.3`               |
| `org.testcontainers`                            | `testcontainers`                                    | `1.18.3`               |
| `org.testcontainers`                            | `tidb`                                              | `1.18.3`               |
| `org.testcontainers`                            | `toxiproxy`                                         | `1.18.3`               |
| `org.testcontainers`                            | `trino`                                             | `1.18.3`               |
| `org.testcontainers`                            | `vault`                                             | `1.18.3`               |
| `org.testcontainers`                            | `yugabytedb`                                        | `1.18.3`               |
...
## 2. 版本属性（Version Properties）

下表提供了可以用来覆盖Spring Boot管理的版本的所有属性。浏览 [`spring-boot-dependencies` build.gradle](https://github.com/spring-projects/spring-boot/tree/main/spring-boot-project/spring-boot-dependencies/build.gradle) 获取完整的依赖关系列表。你可以在[构建工具插件文档](https://springdoc.cn/spring-boot/build-tool-plugins.html#build-tool-plugins)中了解如何在你的应用程序中定制这些版本。
