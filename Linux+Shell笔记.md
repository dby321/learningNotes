...
![1601377528399](.\images\1601377528399.png)

![1601377547956](.\images\1601377547956.png)



![1601377670194](.\images\1601377670194.png)
...
![1601379228726](.\images\1601379228726.png)

#### 1.1.4.Linux的学习方法

![1601379275086](.\images\1601379275086.png)

#### 1.1.5.Linux介绍

> 安全，高效，稳定，处理高并发非常强悍。
>
> 企业级项目都会部署到Linux/Unix服务器运行。

Linux主要的发行版

![1601379950503](.\images\1601379950503.png)
...
![Linux树状目录结构](https://www.runoob.com/wp-content/uploads/2014/06/d0c50-linux2bfile2bsystem2bhierarchy.jpg)
...
![1601434062510](.\images\1601434062510.png)

![解决中文乱码](.\images\1601434170962.png)
...
`|`管道符，将前面的处理结果输出给后面的命令处理

#### 2.6.6.压缩解压类

`gzip 文件名` 将对应的文件压缩为`文件名.gz`文件

`gunzip 文件名.gz` 解压文件

> `gzip`和`gunzip`不会保留原文件

------

`zip`压缩

- `zip -r mypackage.zip /home`压缩整个`/home`目录下的文件到`mypackage.zip`

`unzip`解压

- `unzip -d /opt/tmp/ mypackage.zip`解压`mypackage.zip`到`/opt/tmp`

------

`tar`打包为`.tar.gz`文件

- `tar -zvcf a.tar.gz hello.txt`打包并压缩文件到`a.tar.gz`
- `tar -zxvf a.tar.gz `解压`a.tar.gz`到当前目录
- `tar -zxvf a.tar.gz -C /opt/tmp `解压`a.tar.gz`到`/opt/tmp`【指定解压的目录必须存在】
...
![1601454894445](.\images\1601454894445.png)

- `chown`仅仅修改文件所有者
  - `chown tom apple.txt` 将`apple.txt`文件所有者改成`tom`
  - `chown -R tom kkk/`将`kkk/`文件夹下所有内容的所有者改成`tom`
- `chgrp`仅仅修改文件所在组
  - `chgrp police apple.txt` 将`apple.txt`文件所在组改成`tom`
  - `chgrp -R tom kkk/`将`kkk/`文件夹下所有内容的所在组改成`tom`
- `usermod`修改用户所在组
...
[Linux 文件权限管理的方法](https://www.linuxprobe.com/linux-file-permession.html)

![1601692433424](.\images\1601692433424.png)

![1601692866285](.\images\1601692866285.png)

![1601692825348](.\images\1601692825348.png)



![1644032141629](images/1644032141629.png)
...
![1601693041831](.\images\1601693041831.png)

![1601693293750](.\images\1601693293750.png)
...
![1601694551066](.\images\1601694551066.png)
...
![1601695163300](.\images\1601695163300.png)

![1601695245442](.\images\1601695245442.png)

![1601695318367](.\images\1601695318367.png)
...
![1601695581430](.\images\1601695581430.png)
...
> 1. 虚拟机添加硬盘
>    1. ![1601708002970](.\images\1601708002970.png)
> 2. 分区
>    1. ![1601708073863](.\images\1601708073863.png)
> 3. 格式化
>    1. ![1601708092185](.\images\1601708092185.png)
> 4. 挂载
>    1. ![1601708111427](.\images\1601708111427.png)
> 5. 设置可以自动挂载（永久挂载）
>    1. ![1601708125596](.\images\1601708125596.png)
>    2. ![1601708312909](.\images\1601708312909.png)

> `unmount /dev/sdb1` 取消挂载

#### 2.9.4.磁盘查询指令

- `df -l` 查询系统整体磁盘使用情况
  - ![1601708480130](.\images\1601708480130.png)
- `du -h /目录` 查询指定目录的磁盘占用情况
  - ![1601708578379](.\images\1601708578379.png)
  - ![1601708711785](.\images\1601708711785.png)、
  - ![1601708766114](.\images\1601708766114.png)

#### 2.9.5.磁盘查询实例

1. 统计/home文件夹下文件的个数
   1. ![1601708927385](.\images\1601708927385.png)
2. 统计/home文件夹下目录的个数
   1. ![1601708968837](.\images\1601708968837.png)
3. 统计/home文件夹下文件个数，包括子文件夹中的
   1. ![1601709050419](.\images\1601709050419.png)
4. 统计/home文件夹下文件夹个数，包括子文件夹
   1. ![1601709094333](.\images\1601709094333.png)
5. 以树形显示目录结构
   1. `yum install tree -y` 安装tree命令
   2. ![1601709301121](.\images\1601709301121.png)
...
>
> [CSDN-CentOS7虚拟机上网](https://blog.csdn.net/a785975139/article/details/53023590?utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromMachineLearnPai2%7Edefault-1.control&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromMachineLearnPai2%7Edefault-1.control)

![1601709709378](.\images\1601709709378.png)

1. ![1601709830866](.\images\1601709830866.png)
2. ![1601709846058](.\images\1601709846058.png)
3. ![1601709907941](.\images\1601709907941.png)
4. ![1601710045217](.\images\1601710045217.png)
5. ![1601710137914](.\images\1601710137914.png)

### 2.11.进程管理

#### 2.11.1进程的基本介绍

![1601711176268](.\images\1601711176268.png)
...
![1601711291652](.\images\1601711291652.png)

![1601711359546](.\images\1601711359546.png)

![1601711664659](.\images\1601711664659.png)

![1601711809967](.\images\1601711809967.png)
...
1. 踢掉某个非法登录的用户
   1. ![1601712121241](.\images\1601712121241.png)
2. 终止远程登录服务sshd，在适当时候再重启sshd服务
   1. ![1601712176210](.\images\1601712176210.png)
3. 终止多个gedit编辑器【killall】
   1. ![1601712302072](.\images\1601712302072.png)
4. 强制杀掉一个终端【甚至可以自杀！！！】
   1. ![1601712419874](.\images\1601712419874.png)

#### 2.11.4.服务管理

[CentOS7服务管理（一）](https://www.cnblogs.com/tkqasn/p/9379242.html)
...
> CentOS7之后不再使用`service`，而是使用`systemctl`

`systemctl [start|stop|restart|reload|status] 服务名`

> CentOS7的防火墙是`firewalld`
...
> CentOS7下查看所有服务 `systemctl list-dependencies`

------

>  Linux下的**任务管理器**
>
> [Centos7 进程管理 - 动态监控进程](https://blog.csdn.net/weixin_42909660/article/details/89531467)
...
[Shell命令之复制cp](https://blog.csdn.net/zwlove5280/article/details/74016676)

[Shell带进度条复制cp](https://www.cnblogs.com/lujion/p/6179814.html)

[linux 命令终端提示符显示-bash-4.2#解决方法](https://blog.csdn.net/liulihui1988/article/details/52796395)
